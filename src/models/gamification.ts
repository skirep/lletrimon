...
const POKEMON_TRACKS = [
  {
    ...
    setIds: ['syl-easy-1', 'syl-easy-2', 'syl-easy-3', 'syl-medium-1', 'syl-medium-2', 'syl-medium-3', 'syl-hard-2', 'syl-hard-3', 'syl-hard-100', 'syl-random-50', 'syl-direct-indirect-50'],
  },
  {
    exerciseType: 'words' as const,
    basePower: 28,
    description: 'La branca de paraules transforma cada percentatge en més potència d’atac.',
    setIds: ['words-easy-1', 'words-easy-2', 'words-easy-3', 'words-easy-4', 'words-easy-5', 'words-medium-1', 'words-medium-2', 'words-medium-3', 'words-hard-1', 'words-hard-2', 'words-hard-3', 'words-hard-4', 'words-hard-5', 'w-hard-100', 'words-random-50'],
  },
  {
    exerciseType: 'pseudowords' as const,
    basePower: 34,
    description: 'La branca de pseudoparaules premia la descodificació i la fluïdesa lectora.',
    setIds: ['pseudo-easy-1', 'pseudo-easy-2', 'pseudo-medium-1', 'pseudo-medium-2', 'pseudo-hard-1', 'pseudo-hard-2', 'pseudo-hard-3', 'p-hard-100'],
  },
  {
    exerciseType: 'sentences' as const,
    basePower: 42,
    description: 'La branca de frases culmina en el Pokémon més tècnic i llegendari.',
    setIds: ['sent-easy-1', 'sent-easy-2', 'sent-easy-3', 'sent-medium-1', 'sent-medium-2', 'sent-medium-3', 'sent-hard-1', 'sent-hard-2', 'sent-hard-3', 'sent-hard-4', 'f-hard-100'],
  },
] as const;
...
const LEGENDARY_POKEMON_PATHS = {
  ...
  'pseudo-hard-3-legend': { pokemonId: 493, fallbackName: 'Arceus' },
